...
class File_Save_filepath_Selector() : 
  
  def __init__(self,format_str,mode,size,width_factor,height_factor) :
  ...
  def select_file(self,filetype="*") :
      ...
      self.select_file_file_height_spinner_label=gtk.Label("Height:")
      self.select_file_file_height_spinner_label.show()
      ...
      self.select_file_file_height_spinner_hbox.pack_start(self.select_file_file_height_spinner_label,False,False,0)
      ...
      return (self.filepath_to_return,self.size,self.format_str[1::])
  ...
  def select_file_operation_toplevel_ok(self,widget,event) :
    ...
    if not self.filepath_to_return :
      ...
      '''
        ...
        self.select_file_file_chooser.get_filename()
      '''  
      ...
      '''
        ...
        self.filepath_to_return=self.filepath_to_return
      '''
  ...
  def select_file_operation_update_selection(self,widget,event=False) :
    if not self.select_file_file_chooser.get_filename() or isdir(self.select_file_file_chooser.get_filename()) :
      return 
